package com.head.views.progressbar;
...
/**
*
* 类名称：HeadProgressBar.java <br/>
* 类描述：水平进度条<br/>
* 创建人：shuwen <br/>
* 创建时间：3/18/21 7:05 PM <br/>
* @version
*/
public class HeadProgressBar extends View {
    ...
    public interface OnProgressChangedListener {
        void onProgressChanged(HeadProgressBar progressBar, int max, int progress);
        
        void onSecondProgressChanged(HeadProgressBar progressBar, int max, int progress);
    }
    ...
    public HeadProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    
    public HeadProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.HeadProgressBar);
        mMax = a.getInteger(R.styleable.HeadProgressBar_pbMax, 100);
        mProgress = a.getInteger(R.styleable.HeadProgressBar_pbProgress, 0);
        mBgColor = a.getColor(R.styleable.HeadProgressBar_pbBgColor, 0xff3F51B5);
        mProgressColor = a.getColor(R.styleable.HeadProgressBar_pbColor, 0xffFF4081);
        mSecondProgressColor = a.getColor(R.styleable.HeadProgressBar_pbSecondPbColor, 0xffFF4081);
        mPadding = a.getDimensionPixelSize(R.styleable.HeadProgressBar_pbPadding, 0);
        mShowZeroPoint = a.getBoolean(R.styleable.HeadProgressBar_pbShowZeroPoint, false);
        mShowSecondProgress = a.getBoolean(R.styleable.HeadProgressBar_pbShowSecondProgress, false);
        mSecondProgress = a.getInteger(R.styleable.HeadProgressBar_pbSecondProgress, 0);
        mSecondProgressShape = a.getInteger(R.styleable.HeadProgressBar_pbShowSecondPointShape, SHAPE_POINT);
        mOpenGradient = a.getBoolean(R.styleable.HeadProgressBar_pbOpenGradient, false);
        mGradientFrom = a.getColor(R.styleable.HeadProgressBar_pbGradientFrom, 0xffFF4081);
        mGradientTo = a.getColor(R.styleable.HeadProgressBar_pbGradientTo, 0xffFF4081);
        mOpenSecondGradient = a.getBoolean(R.styleable.HeadProgressBar_pbOpenSecondGradient, false);
        mShowMode = a.getInt(R.styleable.HeadProgressBar_pbShowMode, SHOW_MODE_ROUND);
        mSecondGradientFrom = a.getColor(R.styleable.HeadProgressBar_pbSecondGradientFrom, 0xffFF4081);
        mSecondGradientTo = a.getColor(R.styleable.HeadProgressBar_pbSecondGradientTo, 0xffFF4081);
        mRadius = a.getDimensionPixelSize(R.styleable.HeadProgressBar_pbRoundRectRadius, 20);
        mDrawBorder = a.getBoolean(R.styleable.HeadProgressBar_pbDrawBorder, false);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.HeadProgressBar_pbBorderWidth, 1);
        mBorderColor = a.getColor(R.styleable.HeadProgressBar_pbBorderColor, 0xffff001f);
        a.recycle();
    }
