...
public class HeadSpinner extends AppCompatTextView {
    ...
    private HeadSpinnerBaseAdapter adapter;
    ...
    public HeadSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public HeadSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HeadSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.HeadSpinner);
        ...
        popupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (onSpinnerItemSelectedListener != null) {
                    onSpinnerItemSelectedListener.onItemSelected(HeadSpinner.this, view, position, id);
                }
        ...
        isArrowHidden = typedArray.getBoolean(R.styleable.HeadSpinner_hideArrow, false);
        arrowDrawableTint = typedArray.getColor(R.styleable.HeadSpinner_arrowTint, getResources().getColor(android.R.color.black));
        arrowDrawableResId = typedArray.getResourceId(R.styleable.HeadSpinner_arrowDrawable, R.drawable.arrow);
        dropDownListPaddingBottom =
                typedArray.getDimensionPixelSize(R.styleable.HeadSpinner_dropDownListPaddingBottom, 0);
        horizontalAlignment = PopUpTextAlignment.fromId(
                typedArray.getInt(R.styleable.HeadSpinner_popupTextAlignment, PopUpTextAlignment.CENTER.ordinal())
        );

        CharSequence[] entries = typedArray.getTextArray(R.styleable.HeadSpinner_entries);
        if (entries != null) {
    ...
    private <T> void setAdapterInternal(HeadSpinnerBaseAdapter<T> adapter) {
