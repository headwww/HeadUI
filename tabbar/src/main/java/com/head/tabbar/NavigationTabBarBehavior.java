...
public class NavigationTabBarBehavior extends VerticalScrollingBehavior<HeadTabBar> {
    ...
    @Override
    public boolean onLayoutChild(CoordinatorLayout parent, HeadTabBar child, int layoutDirection) {
        return super.onLayoutChild(parent, child, layoutDirection);
    }


    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, HeadTabBar child, View dependency) {
        return super.onDependentViewChanged(parent, child, dependency);
    }

    @Override
    public void onDependentViewRemoved(CoordinatorLayout parent, HeadTabBar child, View dependency) {
        super.onDependentViewRemoved(parent, child, dependency);
    }

    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, HeadTabBar child, View dependency) {
...
// This method is intentionally empty, because of override
    ...
    @Override
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, HeadTabBar child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
    ...
    @Override
    public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, HeadTabBar child, View directTargetChild, View target, int nestedScrollAxes) {
        return nestedScrollAxes == ViewCompat.SCROLL_AXIS_VERTICAL || super.onStartNestedScroll(coordinatorLayout, child, directTargetChild, target, nestedScrollAxes);
    }

    // Handle scroll direction
    private void handleDirection(HeadTabBar child, int scrollDirection) {
    ...
    // Animate offset
    private void animateOffset(final HeadTabBar child, final int offset, boolean forceAnimation, boolean withAnimation) {
    ...
    private void ensureOrCancelAnimator(final HeadTabBar child, boolean withAnimation) {
    ...
    // Manage animation for Android < KITKAT
    private void ensureOrCancelObjectAnimation(final HeadTabBar child, final int offset, boolean withAnimation) {
    ...
    public static NavigationTabBarBehavior from(HeadTabBar view) {
    ...
    public void hideView(HeadTabBar view, int offset, boolean withAnimation) {
        if (!mHidden) {
            mHidden = true;
    ...
    public void resetOffset(HeadTabBar view, boolean withAnimation) {
        if (mHidden) {
            mHidden = false;
    ...
    private void updateSnackBar(final HeadTabBar child, View dependency) {
