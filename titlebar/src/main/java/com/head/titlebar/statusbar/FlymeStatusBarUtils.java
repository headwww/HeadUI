...
/**
 * 类名称：FlymeStatusBarUtils.java <br/>
 * 类描述：适配魅族<br/>
 * 创建人：shuwen <br/>
 * 创建时间：2020-01-17 14:48 <br/>
 */
    ...
    static {
        try {
            mSetStatusBarColorIcon =
                    Activity.class.getMethod("setStatusBarDarkIcon", int.class);
        } catch (NoSuchMethodException e) {
        }
        try {
            mSetStatusBarDarkIcon =
                    Activity.class.getMethod("setStatusBarDarkIcon", boolean.class);
        } catch (NoSuchMethodException e) {
        }
        try {
            mStatusBarColorFiled =
                    WindowManager.LayoutParams.class.getField("statusBarColor");
        } catch (NoSuchFieldException e) {
        }
        try {
            Field field =
                    View.class.getField("SYSTEM_UI_FLAG_LIGHT_STATUS_BAR");
