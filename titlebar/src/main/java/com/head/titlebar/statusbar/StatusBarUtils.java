package com.head.titlebar.statusbar;
...
/**
 * 类名称：StatusBarUtils.java <br/>
 * 类描述：状态栏适配<br/>
 * 创建人：shuwen <br/>
 * 创建时间：2020-01-17 14:49 <br/>
 *
 * @version
 */
...
public class StatusBarUtils
{
    ...
    {
        return OSUtils.isVivo() || OSUtils.isMiui() || OSUtils.isFlyme()
            || (OSUtils.isOppo()
                && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
            || Build.VERSION.SDK_INT >= Build.VERSION_CODES.M|| Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP;
    }
    ...
    private static void setMIUIStatusBarDarkMode(Window window,
                                                 boolean darkMode)
    {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M)
        {
            ...
            try
            {
                ...
                extraFlagField
                    .invoke(window, darkMode ? darkModeFlag : 0, darkModeFlag);
            }
            catch (Exception e)
            {
            }
    ...
    private static void setFlymeStatusBarDarkMode(Window window,
                                                  boolean darkMode)
    {
    ...
    private static void setOppoStatusBarDarkMode(Window window,
                                                 boolean darkMode)
    {
    ...
    public static boolean checkDeviceHasNavigationBar(Context context)
    {
        ...
        try
        {
            ...
            String navBarOverride =
                (String)m.invoke(systemPropertiesClass, "qemu.hw.mainkeys");
