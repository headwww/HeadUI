...
public class MaterialStyle implements DialogStyle {
    ...
    public int layout(boolean light) {
        return light ? R.layout.layout_dialog_material : R.layout.layout_dialog_material_dark;
    }

    @Override
    public int enterAnimResId() {
        return R.anim.anim_dialog_default_enter;
    }

    @Override
    public int exitAnimResId() {
        return R.anim.anim_dialog_default_exit;
    }
    ...
    public HorizontalButtonRes overrideHorizontalButtonRes() {
        return new HorizontalButtonRes() {
            ...
            public int overrideHorizontalOkButtonBackgroundRes(int visibleButtonCount, boolean light) {
                return light ? R.drawable.button_dialog_material_light : R.drawable.button_dialog_material_night;
            }
    ...
    public WaitTipRes overrideWaitTipRes() {
        return new WaitTipRes() {
            ...
            public int overrideWaitLayout(boolean light) {
                return R.layout.layout_dialog_wait;
            }
            ...
            public ProgressViewInterface overrideWaitView(Context context, boolean light) {
                return new MaterialProgressView(context);
            }
        };
    }
    ...
    public BottomDialogRes overrideBottomDialogRes() {
        return new BottomDialogRes() {
            ...
            public int overrideMenuDividerDrawableRes(boolean light) {
                return light ? R.drawable.rect_dialog_material_menu_split_divider : R.drawable.rect_dialog_material_menu_split_divider_night;
            }
    ...
    public PopTipSettings popTipSettings() {
        return new PopTipSettings() {
            @Override
            public int layout(boolean light) {
                return light ? R.layout.layout_dialog_poptip_material : R.layout.layout_dialog_poptip_material_dark;
            }
