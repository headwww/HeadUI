...
public class PopTip extends BaseDialog {
    ...
    protected DialogStyle.PopTipSettings.ALIGN align;
    ...
    public void show() {
        ...
        int layoutResId = isLightTheme() ? R.layout.layout_dialog_poptip_material : R.layout.layout_dialog_poptip_material_dark;
        if (style.popTipSettings() != null) {
            ...
            if (align == null) align = DialogStyle.PopTipSettings.ALIGN.BOTTOM;
            enterAnimResId = style.popTipSettings().enterAnimResId(isLightTheme()) != 0 ? style.popTipSettings().enterAnimResId(isLightTheme()) : R.anim.anim_dialog_default_enter;
            exitAnimResId = style.popTipSettings().exitAnimResId(isLightTheme()) != 0 ? style.popTipSettings().exitAnimResId(isLightTheme()) : R.anim.anim_dialog_default_exit;
        }
    ...
    public class DialogImpl implements DialogConvertViewInterface {
        ...
        public ImageView imgDialogPopIcon;
        public TextView txtDialogPopText;
        public RelativeLayout boxCustom;
        public TextView txtDialogButton;
        
        public DialogImpl(View convertView) {
            boxRoot = convertView.findViewById(R.id.box_root);
            boxBody = convertView.findViewById(R.id.box_body);
            imgDialogPopIcon = convertView.findViewById(R.id.img_dialogpop_icon);
            txtDialogPopText = convertView.findViewById(R.id.txt_dialogpop_text);
            boxCustom = convertView.findViewById(R.id.box_custom);
            txtDialogButton = convertView.findViewById(R.id.txt_dialogbutton);
        ...
        @Override
        public void init() {
            if (messageTextInfo == null) messageTextInfo = HeadDialog.popTextInfo;
            if (buttonTextInfo == null) buttonTextInfo = HeadDialog.buttonTextInfo;
            ...
            boxRoot.setOnSafeInsetsChangeListener(new OnSafeInsetsChangeListener() {
                ...
                public void onChange(Rect unsafeRect) {
                    if (align == DialogStyle.PopTipSettings.ALIGN.TOP) {
                        boxBody.setY(unsafeRect.top);
                    } else if (align == DialogStyle.PopTipSettings.ALIGN.TOP_INSIDE) {
            ...
            txtDialogButton.setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        public void refreshView() {
            ...
            showText(txtDialogPopText, message);
            showText(txtDialogButton, buttonText);
            
            useTextInfo(txtDialogPopText, messageTextInfo);
            useTextInfo(txtDialogButton, buttonTextInfo);
            
            if (iconResId != 0) {
                imgDialogPopIcon.setVisibility(View.VISIBLE);
                imgDialogPopIcon.setImageResource(iconResId);
                if (autoTintIconInLightOrDarkMode) {
                    imgDialogPopIcon.setImageTintList(txtDialogPopText.getTextColors());
                } else {
                    imgDialogPopIcon.setImageTintList(null);
                }
            } else {
                imgDialogPopIcon.setVisibility(View.GONE);
            }
    ...
    public PopTip setStyle(DialogStyle style) {
        this.style = style;
        return this;
    }
    
    public PopTip setTheme(HeadDialog.THEME theme) {
        this.theme = theme;
        return this;
    }
    ...
    public DialogStyle.PopTipSettings.ALIGN getAlign() {
        return align;
    }
    
    public PopTip setAlign(DialogStyle.PopTipSettings.ALIGN align) {
        this.align = align;
        return this;
    }
