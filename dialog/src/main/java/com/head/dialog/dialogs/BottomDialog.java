...
import com.head.dialog.util.BottomDialogTouchEventInterceptor;
...
/**
 * 类名称：BottomDialog.java <br/>
 * 类描述：底部弹出窗<br/>
 * 创建人：舒文 <br/>
 * 创建时间：3/8/21 8:53 PM <br/>
 */
public class BottomDialog extends BaseDialog {
    ...
    public void show() {
        super.beforeShow();
        int layoutId = isLightTheme() ? R.layout.layout_dialog_bottom_material : R.layout.layout_dialog_bottom_material_dark;
    ...
    public class DialogImpl implements DialogConvertViewInterface {
        ...
        @Override
        public void init() {
            if (titleTextInfo == null) titleTextInfo = HeadDialog.menuTitleInfo;
            ...
            if (okTextInfo == null) okTextInfo = HeadDialog.okButtonTextInfo;
            if (okTextInfo == null) okTextInfo = HeadDialog.buttonTextInfo;
            if (cancelTextInfo == null) cancelTextInfo = HeadDialog.buttonTextInfo;
            ...
            if (cancelText == null) cancelText = HeadDialog.cancelButtonText;
    ...
    public BottomDialog setStyle(DialogStyle style) {
        this.style = style;
        return this;
    }

    public BottomDialog setTheme(HeadDialog.THEME theme) {
        this.theme = theme;
        return this;
    }
