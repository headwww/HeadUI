...
import com.head.dialog.interfaces.BaseOnDialogClickCallback;
        ...
        public void init() {
            ...
            boxRoot.setOnLifecycleCallBack(new DialogBaseRelativeLayout.OnLifecycleCallBack() {
                ...
                public void onShow() {
                    isShow = true;
                    boxRoot.setAlpha(0f);
                    int enterAnimResId = style.enterAnimResId() == 0 ? R.anim.anim_dialog_default_enter : style.enterAnimResId();
                    ...
                    for (int buttonType : style.verticalButtonOrder()) {
                        switch (buttonType) {
                            ...
                            case DialogStyle.BUTTON_OTHER:
                                ...
                                break;
                            case DialogStyle.BUTTON_CANCEL:
